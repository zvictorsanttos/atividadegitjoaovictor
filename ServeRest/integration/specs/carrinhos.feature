...
Funcionalidade: Carrinhos
        ...
        Esquema do Cenário: Buscar carrinho por ID
            ...
            E o carrinho for "<ID>"
            Então deverá retornar schema "get_carrinho_by_id" e "<status>" com "<mensagem>"
                Exemplos:
                    | ID       | status | mensagem                |
        ...
        Esquema do Cenário: Cadastrar carrinhos
            ...
            Então deverá retornar schema "post_carrinho" e "<status>" com "<mensagem>"
                Exemplos:
        ...
        Esquema do Cenário: Excluir carrinho
            ...
            Então deverá retornar schema "delete_carrinho" e "<status>" com "<mensagem>"
                Exemplos:
                    | status | mensagem                                                                      |
        ...
        Esquema do Cenário: Retornar produtos para estoque
            ...
            E cancelar compra
            Então deverá retornar schema "delete_carrinho_return" e "<status>" com "<mensagem>"
                Exemplos:
                    | status | mensagem                                                                      |
                    | 200    | registro excluido com sucesso / não foi encontrado carrinho para esse usuário |
                    | 401    | token ausente, inválido ou expirado                                           |